...
import { calculatorState } from "./reduxSlice";
      ...
      >
        <Container disableGutters maxWidth="xs" sx={{ px: { xs: 2, md: 4 } }}>
          ...
          >
            ...
            {/* Reset and calculate operations */}
            <Grid
              container
              columns={{ xs: 12 }}
              className="extra-small-margin"
              sx={{
                mx: 1,
                py: 1,
              }}
              ...
              <Grid item xs={6} sx={{}}>
                <Button
                  ...
                  sx={{
                    ...
                    mr: 1,
                    py: 1,
                    backgroundColor: `${numberKeys[3].bgcolor}`,
                    fontSize: "1.2rem",
                    fontWeight: "bold",
                    boxShadow: `${numberKeys[3].boxShadow}`,
                    ":hover": {
                      backgroundColor: `${numberKeys[3].hover}`,
                      boxShadow: `${numberKeys[3].boxShadow}`,
                    },
                  }}
                >
              ...
              <Grid item xs={6} sx={{}}>
                <Button
                  ...
                  sx={{
                    ...
                    py: 1,
                    ml: 1,
                    backgroundColor: `${equalBtnColor}`,
                    color: `${selectedTheme === 3 ? "black" : "white"}`,
                    fontSize: "1.2rem",
                    fontWeight: "bold",
                    boxShadow: `${
                      selectedTheme === 3
                        ? "0px 5px 1px -1px hsl(177, 92%, 70%)"
                        : "0px 5px 1px -1px hsl(6, 70%, 34%)"
                    }`,
                    ":hover": {
                      backgroundColor: `${
                        selectedTheme === 3 ? "#04f2e3" : "#db4f3f"
                      }`,
                      boxShadow: `${
                        selectedTheme === 3
                          ? "0px 5px 1px -1px hsl(177, 92%, 70%)"
